...
// ============================================================================
// Legacy Inventory Skew Calculator (for backward compatibility)
// ============================================================================
//
// This is the original implementation of inventory skewing that was in
// src/inventory_skew.rs. It's kept here for backward compatibility.
//
// NOTE: This implementation uses a NEGATIVE sign convention for position skew:
// - When LONG, it produces a NEGATIVE skew (shift quotes down to encourage selling)
// - When SHORT, it produces a POSITIVE skew (shift quotes up to encourage buying)
//
// This differs from StandardInventorySkew above, which uses a positive sign.

/// Calculator for inventory-based price skewing (legacy implementation)
#[derive(Debug)]
...
mod legacy_tests {
    ...
    #[test]
    fn test_legacy_book_imbalance_skew() {
    ...
    #[test]
    fn test_legacy_apply_skew_to_price() {
